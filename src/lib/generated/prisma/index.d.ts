...
export namespace Prisma {
  ...
  */
   ...
   * TrackCountOutputType without action
   */
  export type TrackCountOutputTypeCountLikeArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: LikeWhereInput;
  };
  ...
  > = {
    where?: TrackWhereInput;
    orderBy?:
      | TrackOrderByWithAggregationInput
      | TrackOrderByWithAggregationInput[];
  ...
  type GetTrackGroupByPayload<T extends TrackGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
  ...
  type TrackGetPayload<
    S extends boolean | null | undefined | TrackDefaultArgs,
  > = $Result.GetResult<Prisma.$TrackPayload, S>;
  ...
  > {
    ...
    updateManyAndReturn<T extends TrackUpdateManyAndReturnArgs>(
      args: SelectSubset<T, TrackUpdateManyAndReturnArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$TrackPayload<ExtArgs>,
        T,
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: 'PrismaPromise';
    Like<T extends Track$LikeArgs<ExtArgs> = {}>(
      args?: Subset<T, Track$LikeArgs<ExtArgs>>
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$LikePayload<ExtArgs>,
          T,
  ...
  export type LikeOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<
    'id' | 'userId' | 'trackId' | 'isDislike' | 'createdAt' | 'updatedAt',
    ExtArgs['result']['like']
  >;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    user<T extends UserDefaultArgs<ExtArgs> = {}>(
      ...
      GlobalOmitOptions
    >;
    track<T extends TrackDefaultArgs<ExtArgs> = {}>(
      args?: Subset<T, TrackDefaultArgs<ExtArgs>>
    ): Prisma__TrackClient<
      | $Result.GetResult<
          Prisma.$TrackPayload<ExtArgs>,
          T,
  ...
  export type TrackScalarWhereWithAggregatesInput = {
    ...
    updatedAt?:
      | DateTimeNullableWithAggregatesFilter<'Track'>
      | Date
      | string
      | null;
  };
  ...
  export type LikeCreateNestedManyWithoutTrackInput = {
    create?:
      | XOR<LikeCreateWithoutTrackInput, LikeUncheckedCreateWithoutTrackInput>
      | LikeCreateWithoutTrackInput[]
      | LikeUncheckedCreateWithoutTrackInput[];
    connectOrCreate?:
  ...
  export type LikeUpdateManyWithoutTrackNestedInput = {
    ...
    connectOrCreate?:
      ...
      | LikeCreateOrConnectWithoutTrackInput[];
    upsert?:
      | LikeUpsertWithWhereUniqueWithoutTrackInput
      | LikeUpsertWithWhereUniqueWithoutTrackInput[];
    createMany?: LikeCreateManyTrackInputEnvelope;
    set?: LikeWhereUniqueInput | LikeWhereUniqueInput[];
    disconnect?: LikeWhereUniqueInput | LikeWhereUniqueInput[];
    ...
    connect?: LikeWhereUniqueInput | LikeWhereUniqueInput[];
    update?:
      | LikeUpdateWithWhereUniqueWithoutTrackInput
      | LikeUpdateWithWhereUniqueWithoutTrackInput[];
    updateMany?:
      | LikeUpdateManyWithWhereWithoutTrackInput
      | LikeUpdateManyWithWhereWithoutTrackInput[];
    deleteMany?: LikeScalarWhereInput | LikeScalarWhereInput[];
  };
  ...
  export type UserCreateNestedOneWithoutLikeInput = {
    create?: XOR<
      UserCreateWithoutLikeInput,
      UserUncheckedCreateWithoutLikeInput
    >;
  ...
  export type TrackCreateNestedOneWithoutLikeInput = {
    create?: XOR<
      TrackCreateWithoutLikeInput,
      TrackUncheckedCreateWithoutLikeInput
    >;
  ...
  export type TrackUpdateOneRequiredWithoutLikeNestedInput = {
    ...
    update?: XOR<
      XOR<
        TrackUpdateToOneWithWhereWithoutLikeInput,
        TrackUpdateWithoutLikeInput
      >,
      TrackUncheckedUpdateWithoutLikeInput
    >;
  };
  ...
  export type LikeUpsertWithWhereUniqueWithoutTrackInput = {
    where: LikeWhereUniqueInput;
    update: XOR<
      LikeUpdateWithoutTrackInput,
      LikeUncheckedUpdateWithoutTrackInput
    >;
    create: XOR<
      LikeCreateWithoutTrackInput,
      LikeUncheckedCreateWithoutTrackInput
  ...
  export type LikeUpdateManyWithWhereWithoutTrackInput = {
    ...
    data: XOR<
      LikeUpdateManyMutationInput,
      LikeUncheckedUpdateManyWithoutTrackInput
    >;
  };
